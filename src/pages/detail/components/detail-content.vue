 ...
 * @LastEditTime: 2023-08-27 12:45:18
...
<template>
	<view class="bg-[#fff]">
		<view class="flex items-center px-4 py-2 bg-[#fbb957] text-white">
			<view>¥</view>
			<view class="text-2xl ml-0.5">{{ price }}</view>
		</view>
		<view class="px-2 py-3 b-bottom">
			<view class="text-[#333] truncate">{{ name }}</view>
			<view class="mt-1 text-[#f00] text-sm truncate">{{ desc }}</view>
		</view>
