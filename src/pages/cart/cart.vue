...
<template>
	<app-scroll-view :refresher-enabled="false" :scrolltolower="getMore" :padding-bottom="30">
		<view class="pb-60px">
			<view class="h-50vh center flex-col" v-if="!user">
				<view class="mb-4 text-sm">登录后可查看购物车中的商品</view>
				<view class="bg-[#fbb957] text-center px-12 py-1.5 w-fit rounded-full text-white" @click="goToLogin"
					>去登录</view
				>
			</view>
